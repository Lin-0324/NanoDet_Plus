...
def retinanet_bboxes_encode(boxes, img_id):
    t_boxes = np.zeros((2125, 80, 4), dtype=np.float32)
    t_label = np.full((2125, 80,), 80, dtype=np.int64)
    t_mask = np.zeros((2125, 80,), dtype=np.float32)
