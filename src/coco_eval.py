...
def metrics(pred_data):
    ...
    for sample in pred_data:
        ...
        for c in range(0, 80):
            ...
            score_mask = class_box_scores > 0.05
            class_box_scores = class_box_scores[score_mask]
            class_boxes = pred_boxes[score_mask] * [w / 320, h / 320, w / 320, h / 320]
            # class_boxes = warp_evalboxes(pred_boxes[score_mask], np.linalg.inv(M), w, h)
            if score_mask.any():
