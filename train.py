...
def main():
    ...
    try:
        mox.file.copy_parallel(train_dir , config.train_url)
        print("Successfully Upload {} to {}".format(train_dir ,config.train_url))
    except Exception as e:
        print('moxing upload {} to {} failed: '.format(train_dir ,config.train_url) + str(e))
